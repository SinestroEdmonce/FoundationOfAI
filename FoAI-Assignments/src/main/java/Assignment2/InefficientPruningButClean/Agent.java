...
class DataIO {
    ...
    private void writeHeader2File(BufferedWriter out) {
        try {
            ...
            /**
             * TODO: Time consuming calculation
             */
            out.write("100.0\n");
        }
        catch (Exception e) {
...
public class Agent {
    public static void main(String []args) {
        String in = new String("sources/input10.txt");
        String out = new String("results/output10.txt");
        ...
        try {
            ...
            MinimaxSearch minimax = new MinimaxSearch(dataIO.getModeOfSearch(),
                    ...
                    dataIO.getTimeLimit(), 3);

            minimax.alphaBetaSearch();

            System.out.println(System.currentTimeMillis()-minimax.getBeginOfSearch());
